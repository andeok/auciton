package kr.auction.auth.controller;
...
import kr.auction.auth.config.UserPrincipal;
import kr.auction.auth.controller.cookie.CookieProvider;
import kr.auction.auth.controller.cookie.CookieResolver;
import kr.auction.auth.dto.request.LoginTokenRequest;
import kr.auction.auth.dto.request.LoginRequest;
import kr.auction.auth.dto.request.RegisterRequest;
import kr.auction.auth.dto.response.AuthTokenResponse;
import kr.auction.auth.dto.response.LoginInfomationResponse;
